...
print('Using Omnibenchmark-C data')
...
test_dir = "/home/ids/imarouf/RevisitingCIL/data/omnibenchmark/test/"
...
for method_name in d.keys():
    ...
    for severity in range(5, 6):
        ...
        for img, label in zip(test_data.imgs, test_data.targets):
            ...
            main_folder = os.path.join('/home/ids/imarouf/RevisitingCIL/data/omnibenchmark-C/test/', d[method_name].__name__, level, folder_label)
