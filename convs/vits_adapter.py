...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
                 ...
                 act_layer=None, weight_init='', with_adapter=False, global_pool=False, tuning_config=None):
        """
        Args:
...
@register_model
def vit_base_patch16_224_mocov3_adapter(pretrained=True, adapter=False, **kwargs):
...
def vit_base_patch16_224_sam_adapter(pretrained=True, adapter=False, **kwargs):
    ...
    """
    model = VisionTransformer(num_classes=0, patch_size=16, embed_dim=768, depth=12, num_heads=12, mlp_ratio=4, qkv_bias=True,
                              norm_layer=partial(nn.LayerNorm, eps=1e-6), **kwargs)
...
def vit_base_patch16_clip_224_adapter(pretrained=True, **kwargs) -> VisionTransformer:
    ...
    model_kwargs = dict(
        patch_size=16, embed_dim=768, depth=12, num_heads=12, with_adapter=False, **kwargs)
    pre_model = _create_vision_transformer('vit_base_patch16_clip_224.openai_ft_in12k_in1k',
